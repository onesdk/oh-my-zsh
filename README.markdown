...
```shell
sh -c "$(curl -fsSL https://raw.github.com/e2tox/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.github.com/e2tox/oh-my-zsh/master/tools/install.sh -O -)"
```
...
```shell
export ZSH="~/.dotfiles/oh-my-zsh"; sh -c "$(curl -fsSL https://raw.github.com/e2tox/oh-my-zsh/master/tools/install.sh)"
```
